...
{
    public class LeadAcceptedEvent : Event
    {
        public LeadAcceptedEvent(Guid id, string contactFirstName, string contactFullName, string contactPhoneNumber, string contactEmail,
