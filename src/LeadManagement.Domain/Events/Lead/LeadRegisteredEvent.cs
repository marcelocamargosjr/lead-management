...
{
    public class LeadRegisteredEvent : Event
    {
        public LeadRegisteredEvent(Guid id, string contactFirstName, string contactFullName, string contactPhoneNumber, string contactEmail,
